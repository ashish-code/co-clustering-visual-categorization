...
mbkm2 = MiniBatchKMeans(init="random", k=true_k, max_iter=10, random_state=13,
                       chunk_size=1000)

clustercenters = mbkm.cluster_centers_
mbkm2.cluster_centers_ = clustercenters
code = mbkm2.predict(X)
