...
def ccnblTopic():
    ...
    resultfile = '{0}{1}{2}{3}{4}{5}{6}'.format(rootDir,dataset,outDir,'ccknnTopic',ccType,str(nTopic),str(nCodeword))
    ...
    result['blStd'] = blStd
    result.close()
    outPath = '{0}{1}{2}{3}{4}{5}{6}{7}{8}'.format(rootDir,dataset,outDir,'ccTopic',ccType,str(nTopic),str(nCodeword),'.',figfmt)
    try:
