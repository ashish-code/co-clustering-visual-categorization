...
co-cluster feature descriptor to simultaneously perform dimensionality
reduction and clustering.
column clustering = dimensionality reduction
...
def ccnblWord():
    ...
    plotresult(dataset,catList,ccResult,blResult,figfmt,'CoClusterBOWKNN',ccType)
