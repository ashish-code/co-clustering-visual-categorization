...
Comparison of base-line and co-clustered bag-of-features model
for classification of visual categories using k-NN classifier.
@author: ag00087
'''
...
def ccnblWord():
    ...
    resultfile = '{0}{1}{2}{3}{4}{5}'.format(rootDir,dataset,outDir,'ccknnWord',ccType,str(nCodeword))
    ...
    outPath = '{0}{1}{2}{3}{4}{5}{6}{7}'.format(rootDir,dataset,outDir,'ccknnWord',ccType,str(nCodeword),'.',figfmt)
    try:
